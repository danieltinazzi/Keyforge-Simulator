...
for lang in LANGUAGES:
    ...
    for exp_id in EXPANSIONS:
        ...
        if not os.path.exists(SAVE_DIRECTORY + lang["folder"] + exp_id):
            os.makedirs(SAVE_DIRECTORY + lang["folder"] + exp_id)
...
for lang in LANGUAGES:
    ...
    for exp_id in EXPANSIONS:
        ...
        save_dir = SAVE_DIRECTORY + lang["folder"] + exp_id
        ...
        if card_count < expansion["count"]:
            ...
            print("==== Download of expansion {} in {} already completed ====".format(exp_id, lang["folder"]))
        ...
        while cards_missing:
                ...
                for card in decks["_linked"]["cards"]:  #Get the info for every card
                        ...
                        filename = save_dir + "/" + card_number + ".png"
                ...
                print("==== Downloaded {} out of {} images for expansion {} ====".format(card_count, expansion["count"], exp_id))
                if card_count < expansion["count"]:
                        cards_missing = True
